# `angular-bootstrap` — the fastest start for AngularJS apps
...
To get you started you can simply clone the `angular-bootstrap` repository and install the dependencies:

### Prerequisites

You need git to clone the `angular-bootstrap` repository. You can get git from [here][git].

We also use a number of Node.js tools to initialize and test `angular-bootstrap`. You must have Node.js
and its package manager (npm) installed. You can get them from [here][node].

### Clone `angular-bootstrap`

Clone the `angular-bootstrap` repository using git:

```
git clone https://github.com/mhmdasli/angular-bootstrap.git
...
app/                  --> all of the source files for the application
  ...
  layout/               --> the app view and pages folder
  ...
  partials/             --> html partials footer,header,popups..etc
...
There are two kinds of tests in the `angular-bootstrap` application: Unit tests and end-to-end tests.

### Running Unit Tests

The `angular-bootstrap` app comes preconfigured with unit tests. These are written in [Jasmine][jasmine],
...
The `angular-bootstrap` app comes with end-to-end tests, again written in [Jasmine][jasmine]. These tests
...
up-to-date. The `angular-bootstrap` project is configured to do this automatically before running the
...
The `angular-bootstrap` project supports loading the framework and application scripts asynchronously.
...
The `angular-bootstrap` project comes preconfigured with a local development web server. It is a Node.js
...
your repository and execute scripts such as building the app or running tests. The `angular-bootstrap`
...
## contact
you can contact me via m.ali2910@gmail.com
